...
export interface LifeCareLiteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export namespace RenewalAttemptRejectedEvent {
  export type InputTuple = [policyId: BytesLike, owner: AddressLike];
  export type OutputTuple = [policyId: string, owner: string];
  export interface OutputObject {
    policyId: string;
...
export interface LifeCareLite extends BaseContract {
  connect(runner?: ContractRunner | null): LifeCareLite;
  waitForDeployment(): Promise<this>;

  interface: LifeCareLiteInterface;
  ...
  renewPolicy: TypedContractMethod<
    [arg0: BytesLike, arg1: BigNumberish, arg2: BigNumberish, arg3: BytesLike],
    [void],
    "payable"
  >;
  ...
  >;
  getEvent(
    key: "RenewalAttemptRejected"
  ): TypedContractEvent<
    RenewalAttemptRejectedEvent.InputTuple,
    RenewalAttemptRejectedEvent.OutputTuple,
    RenewalAttemptRejectedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "RenewalAttemptRejected(bytes32,address)": TypedContractEvent<
      RenewalAttemptRejectedEvent.InputTuple,
      RenewalAttemptRejectedEvent.OutputTuple,
      RenewalAttemptRejectedEvent.OutputObject
    >;
    RenewalAttemptRejected: TypedContractEvent<
      RenewalAttemptRejectedEvent.InputTuple,
      RenewalAttemptRejectedEvent.OutputTuple,
      RenewalAttemptRejectedEvent.OutputObject
    >;
