...
export interface HealthCareLiteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  getEvent(
    nameOrSignatureOrTopic:
      ...
      | "PolicyPurchased"
      | "PolicyRefunded"
      | "PolicyRenewed(bytes32,address,uint256,uint256)"
      | "PolicyRenewed(bytes32,address,uint256)"
      | "PremiumCalculated"
      | "RefundIssued"
      | "RoleAdminChanged"
      | "RoleGranted"
  ...
  encodeFunctionData(
    functionFragment: "calculateRefund",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "purchaseHealthPolicy",
...
export namespace ClaimTransferredEvent {
  export type InputTuple = [
    policyId: BytesLike,
...
export namespace PolicyRefundedEvent {
  export type InputTuple = [
    policyId: BytesLike,
    owner: AddressLike,
    refundAmount: BigNumberish
...
export namespace PolicyRenewed_bytes32_address_uint256_uint256_Event {
  export type InputTuple = [
    policyId: BytesLike,
    owner: AddressLike,
    premium: BigNumberish,
...
export namespace PolicyRenewed_bytes32_address_uint256_Event {
  export type InputTuple = [
    policyId: BytesLike,
    owner: AddressLike,
    newExpiry: BigNumberish
...
export namespace PremiumCalculatedEvent {
  ...
  export type OutputTuple = [policyId: string, user: string, premium: bigint];
  export interface OutputObject {
    policyId: string;
    user: string;
    premium: bigint;
...
export interface HealthCareLite extends BaseContract {
  connect(runner?: ContractRunner | null): HealthCareLite;
  waitForDeployment(): Promise<this>;

  interface: HealthCareLiteInterface;
  ...
  calculateRefund: TypedContractMethod<[policyId: BytesLike], [bigint], "view">;
  ...
  purchaseHealthPolicy: TypedContractMethod<
    [
      owner: AddressLike,
      premium: BigNumberish,
      sumAssured: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "calculateRefund"
  ...
  getFunction(
    nameOrSignature: "purchaseHealthPolicy"
  ): TypedContractMethod<
    [
      owner: AddressLike,
      premium: BigNumberish,
  ...
  >;
  getEvent(
    key: "ClaimTransferred"
  ): TypedContractEvent<
    ClaimTransferredEvent.InputTuple,
    ClaimTransferredEvent.OutputTuple,
    ClaimTransferredEvent.OutputObject
  >;
  getEvent(
    key: "PolicyCancelled"
  ): TypedContractEvent<
  ...
  getEvent(
    ...
    PolicyRefundedEvent.InputTuple,
    PolicyRefundedEvent.OutputTuple,
    PolicyRefundedEvent.OutputObject
  >;
  getEvent(
    key: "PolicyRenewed(bytes32,address,uint256,uint256)"
  ): TypedContractEvent<
    PolicyRenewed_bytes32_address_uint256_uint256_Event.InputTuple,
    PolicyRenewed_bytes32_address_uint256_uint256_Event.OutputTuple,
    PolicyRenewed_bytes32_address_uint256_uint256_Event.OutputObject
  >;
  getEvent(
    key: "PolicyRenewed(bytes32,address,uint256)"
  ): TypedContractEvent<
    PolicyRenewed_bytes32_address_uint256_Event.InputTuple,
    PolicyRenewed_bytes32_address_uint256_Event.OutputTuple,
    PolicyRenewed_bytes32_address_uint256_Event.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "ClaimTransferred(bytes32,address,uint256)": TypedContractEvent<
      ClaimTransferredEvent.InputTuple,
      ClaimTransferredEvent.OutputTuple,
      ClaimTransferredEvent.OutputObject
    >;
    ClaimTransferred: TypedContractEvent<
      ClaimTransferredEvent.InputTuple,
      ClaimTransferredEvent.OutputTuple,
      ClaimTransferredEvent.OutputObject
    >;
    ...
    "PolicyRefunded(bytes32,address,uint256)": TypedContractEvent<
      PolicyRefundedEvent.InputTuple,
      PolicyRefundedEvent.OutputTuple,
      PolicyRefundedEvent.OutputObject
    >;
    PolicyRefunded: TypedContractEvent<
      PolicyRefundedEvent.InputTuple,
      PolicyRefundedEvent.OutputTuple,
      PolicyRefundedEvent.OutputObject
    >;
    ...
    "PolicyRenewed(bytes32,address,uint256,uint256)": TypedContractEvent<
      ...
      PolicyRenewed_bytes32_address_uint256_uint256_Event.OutputObject
    >;
    "PolicyRenewed(bytes32,address,uint256)": TypedContractEvent<
      PolicyRenewed_bytes32_address_uint256_Event.InputTuple,
      PolicyRenewed_bytes32_address_uint256_Event.OutputTuple,
      PolicyRenewed_bytes32_address_uint256_Event.OutputObject
    >;

    "PremiumCalculated(bytes32,address,uint256)": TypedContractEvent<
      PremiumCalculatedEvent.InputTuple,
      PremiumCalculatedEvent.OutputTuple,
      PremiumCalculatedEvent.OutputObject
    >;
